...
#
# pkg:gem/bundler-audit#lib/bundler/audit/task.rb:8
class Bundler::Audit::Task < ::Rake::TaskLib
  # Initializes the task.
  #
  # pkg:gem/bundler-audit#lib/bundler/audit/task.rb:15
  def initialize; end
  ...
  # @api private
  #
  # pkg:gem/bundler-audit#lib/bundler/audit/task.rb:37
  ...
  # @api private
  #
  # pkg:gem/bundler-audit#lib/bundler/audit/task.rb:63
  def check; end
  ...
  # @api private
  #
  # pkg:gem/bundler-audit#lib/bundler/audit/task.rb:82
  def update; end
  ...
  #
  # pkg:gem/bundler-audit#lib/bundler/audit/task.rb:91
  def define; end
end

# pkg:gem/bundler-audit#lib/bundler/audit/task.rb:9
